...
## 2026-08-26 四篇 Word 文章完整匯入
- [x] 解析 3Sep2023、5Jan2022、6Sep2023、22Jan2023 的完整文字與內嵌圖片
- [x] 將全部 21 張 Word 圖片上傳至持久化儲存
- [x] 更新四篇「靈感拾光」文章，保留 Word 原始文字／圖片順序
- [x] 按檔名設定發布日期：2023-09-03、2022-01-05、2023-09-06、2023-01-22
- [x] 確認四篇文章均為 culture 類型並更新文章 slug、封面及媒體記錄
- [x] 完成桌面版與 375px 手機版視覺驗證
- [x] 執行 TypeScript 與 Vitest 回歸測試

## 2026-08-26 新增四篇 Word 文章匯入
- [x] 解析 9Sep2023、14Jan2024、18Oct2023、24Nov2023 的完整文字與內嵌圖片
- [x] 上傳並核對全部 Word 圖片資產
- [x] 建立或更新四篇「靈感拾光」文章，保留 Word 原始文字／圖片順序
- [x] 按檔名設定發布日期：2023-09-09、2024-01-14、2023-10-18、2023-11-24
- [x] 確認四篇文章均為 culture 類型並完成封面及媒體記錄
- [x] 完成桌面版與 375px 手機版視覺驗證
- [x] 執行 TypeScript 與 Vitest 回歸測試

## 2026-08-26 再新增四篇 Word 文章匯入
- [x] 解析 13Oct2024、16Nov2024、20Nov2024、24Nov2024 的完整文字與內嵌圖片
- [x] 上傳並核對全部 Word 圖片資產
- [x] 建立或更新四篇「靈感拾光」文章，保留 Word 原始文字／圖片順序
- [x] 按檔名設定發布日期：2024-10-13、2024-11-16、2024-11-20、2024-11-24
- [x] 確認四篇文章均為 culture 類型並完成封面及媒體記錄
- [x] 完成桌面版與 375px 手機版視覺驗證
- [x] 執行 TypeScript 與 Vitest 回歸測試

## 2026-08-26 新增 2025–2026 Word 文章匯入
- [x] 解析 3Dec2025、4April2026、2Dec2025 的完整文字與內嵌圖片
- [x] 上傳並核對三份 Word 的全部圖片資產
- [x] 建立三篇「靈感拾光」文章，保留 Word 原始文字／圖片順序
- [x] 按檔名設定發布日期：2025-12-03、2026-04-04、2025-12-02
- [x] 確認三篇文章均為 culture 類型並完成封面及媒體記錄
- [x] 完成桌面版與 375px 手機版視覺驗證
- [x] 執行 TypeScript 與 Vitest 回歸測試
- [ ] 等待使用者補上第四份 Word 文件後再建立第四篇文章

## 2026-08-26 文章日期排序與熊野古道封面修正
- [x] 將〈東德丫！唔該〉發布日期改為 2021-02-07
- [x] 將〈伊朗奇談 Ten things you might not know about Iran〉發布日期改為 2020-08-14
- [x] 將〈東歐漫遊手記〉發布日期改為 2018-09-09
- [x] 將〈旅遊與刺青 Travel and Tattoo（3）〉發布日期改為 2022-05-05
- [x] 將〈旅遊與刺青 Travel and Tattoo（2）〉發布日期改為 2021-06-16
- [x] 將〈旅遊與刺青 Travel and Tattoo（1）〉發布日期改為 2021-06-07
- [x] 確認文章列表統一按發布日期由新到舊排序
- [x] 找出並替換〈熊野古道：中邊路〉的正確封面圖片
- [x] 完成日期、排序、封面與手機版驗證並執行回歸測試

## 2026-08-26 文章搜尋與靈感主題篩選
- [x] 在文章列表頁頂部加入關鍵字搜尋欄
- [x] 搜尋可比對文章標題、摘要、地點／分類及文章內容
- [x] 在「靈感拾光」加入「全部」、「旅遊」、「隨筆」等主題標籤篩選
- [x] 搜尋與主題篩選可同時使用，並提供無結果提示
- [x] 完成桌面與手機版互動及排版驗證
- [x] 執行 TypeScript 與 Vitest 回歸測試

## 2026-08-26 熊野古道文章封面同步互動網頁
- [x] 取得並確認熊野古道互動網頁的實際首頁封面
- [x] 將文章／行旅資料庫使用的封面替換為該首頁封面
- [x] 驗證文章封面與互動網頁封面一致且圖片正常載入
- [x] 執行 TypeScript 與 Vitest 回歸測試並保存檢查點

## 2026-08-26 社群分享與返回頂部修正
- [x] 在所有文章底部加入 Facebook、LINE、Instagram／複製連結分享操作
- [x] 分享連結使用目前文章標題與網址，並提供鍵盤及手機可用的操作狀態
- [x] 修正左上角 In-Between Days 品牌連結，回到首頁時定位頁面頂部
- [x] 檢查文章返回、相關文章及列表導覽，統一回到目標頁面頂部
- [x] 完成桌面與手機版分享按鈕及返回流程驗證
- [x] 執行 TypeScript 與 Vitest 回歸測試

## 2026-08-26 後台草稿、預覽、排程發布與批量標籤
- [x] 為文章加入可區分草稿、已發布及排程發布的狀態模型
- [x] 建立安全的未公開預覽連結，限制只有具備預覽權杖者可查看
- [x] 讓設定未來發布日期的文章在日期到達後自動出現在前台
- [x] 在後台文章編輯器加入草稿儲存、預覽及排程發布操作
- [x] 在後台文章清單加入狀態／排程日期顯示與篩選
- [x] 加入文章標籤資料模型及編輯器管理
- [x] 在後台支援批量套用及移除文章標籤
- [x] 驗證一般訪客無法查看草稿或未到期排程文章
- [x] 完成桌面／手機版後台流程驗證並執行回歸測試

## 2026-08-26 後台手機版版面修正
- [x] 讓管理後台在手機寬度隱藏固定側欄並提供可橫向瀏覽的行動導覽
- [x] 重新驗證文章清單、批量標籤區及文章編輯器在手機版的可用寬度

## 2026-08-26 後台手機版版面修正
- [x] 讓管理後台在手機寬度隱藏固定側欄並提供可橫向瀏覽的行動導覽
- [x] 重新驗證文章清單、批量標籤區及文章編輯器在手機版的可用寬度

## 2026-08-26 首頁立即訂閱區塊優化
- [x] 優化「立即訂閱」區塊的標題、引導文案與資訊層次
- [x] 改善姓名及 Email 欄位的 label、placeholder、autocomplete 與輸入提示
- [x] 保留並改善隱私權政策連結、同意勾選及取消操作
- [x] 改善提交中、成功、錯誤及雙重確認提示的表單狀態
- [x] 完成桌面／手機版訂閱區塊視覺驗證
- [x] 執行 TypeScript 與 Vitest 回歸測試
